...
<html lang="en" >
    <head>
     ...
     <!---<link href="<?php //echo base_url(); ?>assets/scripts/chosen_v1.1.0/chosen.css" rel="stylesheet"/>
        <script src="<?php //echo base_url(); ?>assets/scripts/chosen_v1.1.0/chosen.jquery.js"></script>-->
        ...
        <script type="text/javascript">
		    ...
		    function saveData(){
				...
				if(last_row.find(".qty_disp").val()==0 || last_row.find(".qty_disp").val()=="" || isNaN(last_row.find(".qty_disp").val())==true){
					bootbox.alert("<h4>/No Quantity!</h4>\n\<hr/><center>You have not entered the quantity being dispensed for the last commodity entered!!</center>");
					return;
				}

				if(last_row.find(".qty_disp").hasClass("input_error")){
					bootbox.alert("<h4>Excess Quantity!</h4>\n\<hr/><center>The quantity of the last commodity being dispensed is greater that the quantity available!</center>");
					return;
				}
        ...
        <div class="full-content" style="background: #E98CBF">
            ...
            <form id="dispense_form"  name="dispense_form" class="dispense_form" method="post"  action="<?php echo base_url() . 'dispensement_management/save'; ?>"   >
                ...
                <div class="content-rowy" style="height:auto;">
                    ...
                    if ($count_ccc > 0) {
                        echo "
								...
								<select name='ccc_store_id' id='ccc_store_id' >";
                        ...
                        <tbody>
                            <tr drug_row="0">
                                ...
                                <td class="dose_col">
                                    ...
                                    <datalist id="dose" class="dose"><select name="dose[]" class="dose"></select></datalist>
                                </td>
                                <td>
                ...
                <div id="submit_section">
                    ...
                    <input form="dispense_form" id="btn_submit " class="btn actual button_size" id="submit"  value="Dispense Drugs"/>
                </div>
            </form>
