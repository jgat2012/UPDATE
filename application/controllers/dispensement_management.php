...
class Dispensement_Management extends MY_Controller {
	...
	public function dispense($record_no) {
		...
		$sql = "select * from patient where id='$record_no' and facility_code='$facility_code'";
	...
	public function save() {
		...
		$sql .= "update patient SET weight='$weight',height='$height',current_regimen='$current_regimen',nextappointment='$next_appointment_date' where patient_number_ccc ='$patient' and facility_code='$facility';";
