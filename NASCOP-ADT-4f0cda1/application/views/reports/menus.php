	...
	<div id="edit_donor_date_range_report" title="Select Date Range and Donor">
		<table>
			...
			<tr><td><strong>From :</strong></td>
				<td>
					<input type="text"name="edit_donor_date_range_from" id="edit_donor_date_range_from">
				</td>
			</tr>
			<tr><td><strong>To :</strong></td>
				<td>
					<input type="text"name="edit_donor_date_range_to" id="edit_donor_date_range_to">
				</td>
			</tr>
		</table>
		
		<button id="edit_donor_generate_date_range_report"  style="height:30px; font-size: 13px; width: 200px;">
			Generate Report
		</button>
	</div>
	-->
